...
const Product = () => {
  ...
  return productData ? (
    <div className='border-t-2 pt-10 tranition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An E-Commerce website is an online platform which allows the user to buy and sell products online over the internet </p>
          <p>E-Commerce website typically displays products or services along with detailed description,images and cost</p>
        </div>
      </div>
